...
//    [renderer](std::shared_ptr<Widget2>& child_ptr) {
...
//  }
//
//  Widget2* child = child_consumes_event(&Widget2::KeyPressed, kb_args);
//  if (child) {
...
//  child_consumes_event(&Widget2::KeyReleased, kb_args);
//  return true;
//}
//
//bool game_ui::MainMenu_Screen::LeftButtonDown(MouseEventArgs* ms_args) {
//  Widget2* child = child_consumes_event(&Widget2::LeftButtonDown,  ms_args);
...
//  child_consumes_event(&Widget2::LeftButtonUp, ms_args);
//  return true;
//}
//
...
//  });*/
//  child_consumes_event(&Widget2::MouseMoved, ms_args);
//  return true;
//}
//
//void game_ui::MainMenu_Screen::on_button_clicked_or_keyactivated(Widget2* child) {
//
//  switch (child->get_id()) {
